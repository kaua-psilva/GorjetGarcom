...
function calcularGorjeta() {
    ...
    const QtdPessoas = parseFloat(numPessoas.value) || 1;
    ...
    function calcularTotais() {
        ...
        document.getElementById('totalContaUser').innerText = totalGorjetaPorPessoa.toFixed(2) + "R$";
        document.getElementById('totalGorjeta').innerText = totalPorPessoa.toFixed(2) + "R$";
    }
    calcularTotais();
    // VERIFICAR VALORES 0 Á CIMMA DE 0
    if(contaUser <= 0){
        alert("Insira somente valores superiores á 0")
    }else{
        log("Valores válidos")
    }
    calcularTotais()
